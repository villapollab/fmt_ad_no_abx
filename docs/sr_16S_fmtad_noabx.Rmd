...
description: |
  A research study focused on observing the links between the fecal matter transplants (FMTs), TBI, and the gut microbiome.
author:
...
This vignette contains all of the code necessary for the microbiome analysis within our paper named "". In this study, we researched the relationship between antibiotics, traumatic brain injury, and the gut microbiome. The gut microbiome analysis of this study was performed through short-read 16S V1-V3 sequencing performed at Baylor College of Medicine with raw fastq data accessible at BioProject [??](https://www.ncbi.nlm.nih.gov/bioproject/).
...
This sometimes can be a bit funky
